...
* [`WebCore.UpdateState`]()
* [`WebCore.QueueWork`]()
* [`WebCore.IsInitialized`]()
* [`WebCore.IsChildProcess`]()
* [`WebCore.ChildProcessMain`]()
* [`WebConfig.AssetProtocol`]()
* [`WebConfig.DEBUGGING_HOST_DEFAULT`]()
* [`WebCoreUpdateState`]()
* [`IWebView.SaveImageAt`]()
* [`IWebView.HTML`]()
* [`IWebView.RenderProcess`]()
* [`WebSession.ReservedAssetHosts`]()
* [`IResourceRequest`]()
* [`Utilities.ToWebRequest`]() ([`IResourceRequest`]() extension)
* [`DataSource.CATCH_ALL`]()
* [`DownloadCollection.Remove`]()
* [`DownloadItem.Remove`]()
* [`DownloadItem.OriginViewId`]()
* [`ThreadAffinityEnsuredAttribute`]()

##### Awesomium.Windows.Controls (WPF)

* [`WebDialogsLayer`]()
* [`SourceBinding.Converter`]()
* [`SourceBinding.ConverterParameter`]()
* [`WebControlCommands.SaveImageAs`]()

#### Modified API:

##### Awesomium.Core

* [`IWebView+ISynchronizeInvoke`]()
* [`ViewModel.OnPropertyChanged`]() (removed sender)
* [`DataSourceRequest+IResourceRequest`]()
...
* Made it so `DocumentReady` is fired on *`window.open`* child views (#25)
